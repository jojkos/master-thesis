...
\todo{asi nekde vysvetlit operaci kolecko \\circ}
...
\begin{figure}
    \begin{center}
            \tmpframe{\includegraphics[width=0.8\linewidth]{img/placeholder.pdf}}
    \end{center}
	\caption{\todo{nějakej cool obrázek jako je v tutorialu figure 17, strana 32}}
	\label{img:LSTM}
\end{figure}
...
\textbf{Seq2seq} (článek \cite{seq2seq}) nebo-li sequence to sequence je způsob překladu po celých větách. Jde o modelování pravděpodobnosti $P(E|F)$ tedy pravděpodobnost výstupu $E$ na základě vstupu $F$ (obrázek \todo{obrázek s jednou větou přeloženou do jiné a znázornění pravděpodobností}).

\begin{figure}
    \begin{center}
            \tmpframe{\includegraphics[width=0.5\linewidth]{img/placeholder.pdf}}
    \end{center}
	\caption{\todo{seq2seq a probability}}
...
\begin{figure}
    \begin{center}
            \tmpframe{\includegraphics[width=0.5\linewidth]{img/placeholder.pdf}}
    \end{center}
	\caption{\todo{pořádná ukázka seq2seq asi jako je v nmt thesi}}
	\label{img:seq2seq}
\end{figure}
