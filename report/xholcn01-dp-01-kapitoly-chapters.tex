...
\todo{Obsahuje beam search s normalizaci skore podle delky vety..co dal?, bi-directional encoder, multi layering}
\\\\\\
...
\todo{ze jsem se hodne zameroval na experimenty a data, ale chtel bych vylepsit dekompozici knihovny a jeji api}
