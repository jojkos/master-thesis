...
\todo{\url{https://arxiv.org/abs/1610.09038} teacher forcing citace}
...
\todo{Obsahuje beam search s normalizaci skore podle delky vety..co dal?, bi-directional encoder, multi layering, nejak zhruba popsat ze je v tom vystavenej celej ten encoder-decoder model}
\\\\\\
...
\begin{figure}[H]
    \begin{center}
            \tmpframe{\includegraphics[width=0.55\linewidth]{img/model.pdf}}
    \end{center}
