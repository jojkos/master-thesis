...
\subsection{Výsledky}
Všechny dosažené výsledky získané s~cs-en testovacím datasetem jsou shrnuty v~tabulce \ref{table:results}. Ukázky překladů jsou v~tabulce \ref{img:exampleResults}.
